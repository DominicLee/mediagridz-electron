  ...
  <q-dialog ref="dialogRef" @hide="onDialogHide">
    <q-card class="new-playlist">
      ...
      <q-card-section class="q-gutter-sm">
        ...
        <q-select outlined dense color="accent" label="Add tags" use-chips multiple v-model="selectedTags"
                  :options="['thing', 'another thing']"></q-select>
        <q-select outlined dense label="Add model(s)" use-chips multiple v-model="selectedModels"
                  :options="['Paula', 'another thing']"></q-select>
      </q-card-section>
