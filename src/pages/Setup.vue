    ...
    >
      ...
      >
        <div class="setup-stepper-content overflow-hidden">
          ...
          <div class="pv-text-body-2 text-grey-6">In order to convert files from formats that pr0nView doesn't support
            natively (e.g. MKV), you can use FFMPEG. If you don't have the FFMPEG binary (exe) already on your computer,
            you can
      ...
      >
        <div class="setup-stepper-content overflow-hidden">
          ...
          <div class="pv-text-body-2 text-grey-6">pr0nView can use AI to help you rename or tag items in your library.
            In order to do so you will need to sign up to OpenAI and get an API key. WARNING: Using AI exposes at least
            the names of your files. However, using the OpenAI API is private and secured.
          </div>
          <div class="row q-gutter-sm q-mt-xs">
            <div class="row col-grow">
          ...
          <q-btn class="q-mt-md" outline label="Help me set up an OpenAI account" size="sm" no-caps
                 color="accent"></q-btn>
        </div>
      </q-step>
